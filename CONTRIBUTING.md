...
For the comparative report, use its `claim-ledger.json` passage IDs. For the AI/protein literature review, use the numbered references and the source-register IDs. For orientation notes, include the heading and linked source.
